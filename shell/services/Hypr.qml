...
Singleton {
    ...
    function reloadDynamicConfs(): void {
        extras.batchMessage(["keyword bindlni ,Caps_Lock,global,webb:refreshDevices", "keyword bindlni ,Num_Lock,global,webb:refreshDevices"]);
    }
    ...
    FileView {
        ...
        path: Quickshell.env("WEBB_XKB_RULES_PATH") || "/usr/share/X11/xkb/rules/base.lst"
        onLoaded: {
