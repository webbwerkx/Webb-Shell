...
from webb.utils.hypr import message
...
from webb.utils.scheme import Scheme, get_scheme
from webb.utils.theme import apply_colours
...
def get_smart_opts(wall: Path, cache: Path) -> dict:
    ...
    from webb.utils.colourfulness import get_variant
...
def set_wallpaper(wall: Path | str, no_smart: bool) -> None:
    ...
    apply_colours(scheme.colours, scheme.mode, wallpaper_path=wall)
