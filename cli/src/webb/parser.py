...
from webb.subcommands import clipboard, emoji, record, resizer, scheme, screenshot, shell, toggle, wallpaper
from webb.utils.paths import wallpapers_dir
from webb.utils.scheme import get_scheme_names, scheme_variants
from webb.utils.wallpaper import get_wallpaper


def parse_args() -> tuple[argparse.ArgumentParser, argparse.Namespace]:
    parser = argparse.ArgumentParser(prog="webb", description="Main control script for the Webb dotfiles")
    ...
    wallpaper_parser.add_argument(
        ...
        "--threshold",
        default=0.8,
        help="the minimum percentage of the largest monitor size the image must be greater than",
    )
    wallpaper_parser.add_argument(
        "-N",
        "--no-smart",
