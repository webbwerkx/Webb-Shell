...
from webb.utils.notify import close_notification, notify
from webb.utils.paths import recording_notif_path, recording_path, recordings_dir, user_config_path
    ...
    def start(self) -> None:
        ...
        try:
            if proc.wait(1) != 0:
                ...
                notify(
                    "Recording failed",
                    f"An error occurred attempting to start recorder. "
